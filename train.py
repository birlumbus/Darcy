...
formatted_samples = load_data("./training_data/training_text/labeled_training_data_2.json")

print(formatted_samples[0])
print(formatted_samples[1])
print(formatted_samples[2])
print(formatted_samples[3])
print(formatted_samples[4])
print(formatted_samples[5])
print(formatted_samples[6])
print(formatted_samples[7])
print(formatted_samples[8])
print(formatted_samples[9])
